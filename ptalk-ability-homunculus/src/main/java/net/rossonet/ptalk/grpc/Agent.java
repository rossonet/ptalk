...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_Agent_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_Agent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            net.rossonet.ptalk.grpc.Agent.class, net.rossonet.ptalk.grpc.Agent.Builder.class);
  }
  ...
  private net.rossonet.ptalk.grpc.RegisterReply registerData_;
  /**
   ...
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.RegisterReply getRegisterData() {
    return registerData_ == null ? net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance() : registerData_;
  }
  /**
   * <code>.beacon.RegisterReply registerData = 3;</code>
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.RegisterReplyOrBuilder getRegisterDataOrBuilder() {
    return registerData_ == null ? net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance() : registerData_;
  }
  ...
  private net.rossonet.ptalk.grpc.Timestamp lastContact_;
  /**
   ...
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.Timestamp getLastContact() {
    return lastContact_ == null ? net.rossonet.ptalk.grpc.Timestamp.getDefaultInstance() : lastContact_;
  }
  /**
   * <code>.beacon.Timestamp lastContact = 5;</code>
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.TimestampOrBuilder getLastContactOrBuilder() {
    return lastContact_ == null ? net.rossonet.ptalk.grpc.Timestamp.getDefaultInstance() : lastContact_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof net.rossonet.ptalk.grpc.Agent)) {
      return super.equals(obj);
    }
    net.rossonet.ptalk.grpc.Agent other = (net.rossonet.ptalk.grpc.Agent) obj;
  ...
  public static net.rossonet.ptalk.grpc.Agent parseFrom(
  ...
  public static net.rossonet.ptalk.grpc.Agent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static net.rossonet.ptalk.grpc.Agent parseFrom(
  ...
  public static net.rossonet.ptalk.grpc.Agent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static net.rossonet.ptalk.grpc.Agent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static net.rossonet.ptalk.grpc.Agent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(net.rossonet.ptalk.grpc.Agent prototype) {
  ...
  public static final class Builder extends
      ...
      net.rossonet.ptalk.grpc.AgentOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_Agent_descriptor;
    }
    ...
    // Construct using net.rossonet.ptalk.grpc.Agent.newBuilder()
    private Builder() {
    ...
    public Builder clear() {
      ...
      if (registerDataBuilder_ != null) {
        registerDataBuilder_.dispose();
        registerDataBuilder_ = null;
      }
      jsonHardwareInfo_ = "";
      lastContact_ = null;
      if (lastContactBuilder_ != null) {
        lastContactBuilder_.dispose();
    ...
    @java.lang.Override
    public net.rossonet.ptalk.grpc.Agent getDefaultInstanceForType() {
      return net.rossonet.ptalk.grpc.Agent.getDefaultInstance();
    }

    @java.lang.Override
    public net.rossonet.ptalk.grpc.Agent build() {
      net.rossonet.ptalk.grpc.Agent result = buildPartial();
    ...
    @java.lang.Override
    public net.rossonet.ptalk.grpc.Agent buildPartial() {
      net.rossonet.ptalk.grpc.Agent result = new net.rossonet.ptalk.grpc.Agent(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(net.rossonet.ptalk.grpc.Agent result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.registerData_ = registerDataBuilder_ == null
            ? registerData_
            : registerDataBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.jsonHardwareInfo_ = jsonHardwareInfo_;
      }
      if (((from_bitField0_ & 0x00000010) != 0)) {
        result.lastContact_ = lastContactBuilder_ == null
            ? lastContact_
            : lastContactBuilder_.build();
      }
    }

    @java.lang.Override
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof net.rossonet.ptalk.grpc.Agent) {
        return mergeFrom((net.rossonet.ptalk.grpc.Agent)other);
      } else {
    ...
    public Builder mergeFrom(net.rossonet.ptalk.grpc.Agent other) {
      if (other == net.rossonet.ptalk.grpc.Agent.getDefaultInstance()) return this;
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        net.rossonet.ptalk.grpc.RegisterReply, net.rossonet.ptalk.grpc.RegisterReply.Builder, net.rossonet.ptalk.grpc.RegisterReplyOrBuilder> registerDataBuilder_;
    /**
     * <code>.beacon.RegisterReply registerData = 3;</code>
     * @return Whether the registerData field is set.
     */
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public Builder setRegisterData(net.rossonet.ptalk.grpc.RegisterReply value) {
      if (registerDataBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setRegisterData(
        net.rossonet.ptalk.grpc.RegisterReply.Builder builderForValue) {
      if (registerDataBuilder_ == null) {
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public Builder mergeRegisterData(net.rossonet.ptalk.grpc.RegisterReply value) {
      if (registerDataBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          registerData_ != null &&
          registerData_ != net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance()) {
          getRegisterDataBuilder().mergeFrom(value);
        } else {
          registerData_ = value;
        }
      } else {
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public net.rossonet.ptalk.grpc.RegisterReply.Builder getRegisterDataBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
    ...
    public net.rossonet.ptalk.grpc.RegisterReplyOrBuilder getRegisterDataOrBuilder() {
      if (registerDataBuilder_ != null) {
        ...
        return registerData_ == null ?
            net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance() : registerData_;
      }
    }
    /**
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        net.rossonet.ptalk.grpc.RegisterReply, net.rossonet.ptalk.grpc.RegisterReply.Builder, net.rossonet.ptalk.grpc.RegisterReplyOrBuilder> 
    ...
    private net.rossonet.ptalk.grpc.Timestamp lastContact_;
    private com.google.protobuf.SingleFieldBuilderV3<
        net.rossonet.ptalk.grpc.Timestamp, net.rossonet.ptalk.grpc.Timestamp.Builder, net.rossonet.ptalk.grpc.TimestampOrBuilder> lastContactBuilder_;
    /**
     * <code>.beacon.Timestamp lastContact = 5;</code>
     * @return Whether the lastContact field is set.
     */
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public Builder setLastContact(net.rossonet.ptalk.grpc.Timestamp value) {
      if (lastContactBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public Builder mergeLastContact(net.rossonet.ptalk.grpc.Timestamp value) {
      if (lastContactBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
          lastContact_ != null &&
          lastContact_ != net.rossonet.ptalk.grpc.Timestamp.getDefaultInstance()) {
          getLastContactBuilder().mergeFrom(value);
        } else {
          lastContact_ = value;
        }
      } else {
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public net.rossonet.ptalk.grpc.Timestamp.Builder getLastContactBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
    ...
    public net.rossonet.ptalk.grpc.TimestampOrBuilder getLastContactOrBuilder() {
      if (lastContactBuilder_ != null) {
        ...
        return lastContact_ == null ?
            net.rossonet.ptalk.grpc.Timestamp.getDefaultInstance() : lastContact_;
      }
    }
    /**
     * <code>.beacon.Timestamp lastContact = 5;</code>
  ...
  private static final net.rossonet.ptalk.grpc.Agent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new net.rossonet.ptalk.grpc.Agent();
  }

  public static net.rossonet.ptalk.grpc.Agent getDefaultInstance() {
