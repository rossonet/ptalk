...
/**
 * Protobuf type {@code channelGrpc.LogRequest}
 */
public final class LogRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:channelGrpc.LogRequest)
    LogRequestOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return net.rossonet.ptalk.channel.protobuf.server.grpc.PtalkChannelGrpcServerGrpc.internal_static_channelGrpc_LogRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return net.rossonet.ptalk.channel.protobuf.server.grpc.PtalkChannelGrpcServerGrpc.internal_static_channelGrpc_LogRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest.class, net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest.Builder.class);
  }
   ...
   * @return The severity.
   */
  @java.lang.Override public net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity getSeverity() {
    @SuppressWarnings("deprecation")
    net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity result = net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity.valueOf(severity_);
    return result == null ? net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (severity_ != net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity.DEFAULT.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest)) {
      return super.equals(obj);
    }
    net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest other = (net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest) obj;
  ...
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseFrom(
  ...
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseFrom(
  ...
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:channelGrpc.LogRequest)
      net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.rossonet.ptalk.channel.protobuf.server.grpc.PtalkChannelGrpcServerGrpc.internal_static_channelGrpc_LogRequest_descriptor;
    }
    ...
    // Construct using net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest getDefaultInstanceForType() {
      return net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest.getDefaultInstance();
    }

    @java.lang.Override
    public net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest build() {
      net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest result = buildPartial();
    ...
    @java.lang.Override
    public net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest buildPartial() {
      net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest result = new net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest(this);
      if (agentSenderBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest) {
        return mergeFrom((net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest)other);
      } else {
    ...
    public Builder mergeFrom(net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest other) {
      if (other == net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest.getDefaultInstance()) return this;
     ...
     */
    @java.lang.Override
    public net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity getSeverity() {
      @SuppressWarnings("deprecation")
      net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity result = net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity.valueOf(severity_);
      return result == null ? net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setSeverity(net.rossonet.ptalk.channel.protobuf.server.grpc.LogSeverity value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:channelGrpc.LogRequest)
  }

  // @@protoc_insertion_point(class_scope:channelGrpc.LogRequest)
  private static final net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest();
  }

  public static net.rossonet.ptalk.channel.protobuf.server.grpc.LogRequest getDefaultInstance() {
