...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_RegisterReply_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_RegisterReply_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            net.rossonet.ptalk.grpc.RegisterReply.class, net.rossonet.ptalk.grpc.RegisterReply.Builder.class);
  }
  ...
  private int monitoringFrequency_ = 0;
  /**
  ...
  private net.rossonet.ptalk.grpc.Status statusRegistration_;
  /**
   ...
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.Status getStatusRegistration() {
    return statusRegistration_ == null ? net.rossonet.ptalk.grpc.Status.getDefaultInstance() : statusRegistration_;
  }
  /**
   * <code>.beacon.Status statusRegistration = 5;</code>
   */
  @java.lang.Override
  public net.rossonet.ptalk.grpc.StatusOrBuilder getStatusRegistrationOrBuilder() {
    return statusRegistration_ == null ? net.rossonet.ptalk.grpc.Status.getDefaultInstance() : statusRegistration_;
  }

  public static final int TIMESTAMPREGISTRATION_FIELD_NUMBER = 6;
  private long timestampRegistration_ = 0L;
  /**
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof net.rossonet.ptalk.grpc.RegisterReply)) {
      return super.equals(obj);
    }
    net.rossonet.ptalk.grpc.RegisterReply other = (net.rossonet.ptalk.grpc.RegisterReply) obj;
  ...
  public static net.rossonet.ptalk.grpc.RegisterReply parseFrom(
  ...
  public static net.rossonet.ptalk.grpc.RegisterReply parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static net.rossonet.ptalk.grpc.RegisterReply parseFrom(
  ...
  public static net.rossonet.ptalk.grpc.RegisterReply parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static net.rossonet.ptalk.grpc.RegisterReply parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static net.rossonet.ptalk.grpc.RegisterReply parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(net.rossonet.ptalk.grpc.RegisterReply prototype) {
  ...
  public static final class Builder extends
      ...
      net.rossonet.ptalk.grpc.RegisterReplyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.rossonet.ptalk.grpc.PtaskNluApi.internal_static_beacon_RegisterReply_descriptor;
    }
    ...
    // Construct using net.rossonet.ptalk.grpc.RegisterReply.newBuilder()
    private Builder() {
    ...
    public Builder clear() {
      ...
      if (statusRegistrationBuilder_ != null) {
        statusRegistrationBuilder_.dispose();
    ...
    @java.lang.Override
    public net.rossonet.ptalk.grpc.RegisterReply getDefaultInstanceForType() {
      return net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance();
    }

    @java.lang.Override
    public net.rossonet.ptalk.grpc.RegisterReply build() {
      net.rossonet.ptalk.grpc.RegisterReply result = buildPartial();
    ...
    @java.lang.Override
    public net.rossonet.ptalk.grpc.RegisterReply buildPartial() {
      net.rossonet.ptalk.grpc.RegisterReply result = new net.rossonet.ptalk.grpc.RegisterReply(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(net.rossonet.ptalk.grpc.RegisterReply result) {
      ...
      if (((from_bitField0_ & 0x00000010) != 0)) {
        result.statusRegistration_ = statusRegistrationBuilder_ == null
            ? statusRegistration_
            : statusRegistrationBuilder_.build();
      }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof net.rossonet.ptalk.grpc.RegisterReply) {
        return mergeFrom((net.rossonet.ptalk.grpc.RegisterReply)other);
      } else {
    ...
    public Builder mergeFrom(net.rossonet.ptalk.grpc.RegisterReply other) {
      if (other == net.rossonet.ptalk.grpc.RegisterReply.getDefaultInstance()) return this;
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        net.rossonet.ptalk.grpc.Status, net.rossonet.ptalk.grpc.Status.Builder, net.rossonet.ptalk.grpc.StatusOrBuilder> statusRegistrationBuilder_;
    /**
     * <code>.beacon.Status statusRegistration = 5;</code>
     * @return Whether the statusRegistration field is set.
     */
     ...
     * <code>.beacon.Status statusRegistration = 5;</code>
     */
    public Builder setStatusRegistration(net.rossonet.ptalk.grpc.Status value) {
      if (statusRegistrationBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.beacon.Status statusRegistration = 5;</code>
     */
    public Builder mergeStatusRegistration(net.rossonet.ptalk.grpc.Status value) {
      if (statusRegistrationBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
          statusRegistration_ != null &&
          statusRegistration_ != net.rossonet.ptalk.grpc.Status.getDefaultInstance()) {
          getStatusRegistrationBuilder().mergeFrom(value);
        } else {
          statusRegistration_ = value;
        }
      } else {
     ...
     * <code>.beacon.Status statusRegistration = 5;</code>
     */
    public net.rossonet.ptalk.grpc.Status.Builder getStatusRegistrationBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
    ...
    public net.rossonet.ptalk.grpc.StatusOrBuilder getStatusRegistrationOrBuilder() {
      if (statusRegistrationBuilder_ != null) {
        ...
        return statusRegistration_ == null ?
            net.rossonet.ptalk.grpc.Status.getDefaultInstance() : statusRegistration_;
      }
    }
    /**
     * <code>.beacon.Status statusRegistration = 5;</code>
  ...
  private static final net.rossonet.ptalk.grpc.RegisterReply DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new net.rossonet.ptalk.grpc.RegisterReply();
  }

  public static net.rossonet.ptalk.grpc.RegisterReply getDefaultInstance() {
