...
public final class RpcAbilityUnitV1Grpc {
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void callSync(net.rossonet.ptalk.ability.grpc.AbilityMessageRequest request,
  ...
  /**
   * Base class for the server implementation of the service RpcAbilityUnitV1.
   */
  public static abstract class RpcAbilityUnitV1ImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return RpcAbilityUnitV1Grpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service RpcAbilityUnitV1.
   */
  public static final class RpcAbilityUnitV1Stub
      extends io.grpc.stub.AbstractAsyncStub<RpcAbilityUnitV1Stub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service RpcAbilityUnitV1.
   */
  public static final class RpcAbilityUnitV1BlockingStub
      extends io.grpc.stub.AbstractBlockingStub<RpcAbilityUnitV1BlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service RpcAbilityUnitV1.
   */
  public static final class RpcAbilityUnitV1FutureStub
      extends io.grpc.stub.AbstractFutureStub<RpcAbilityUnitV1FutureStub> {
