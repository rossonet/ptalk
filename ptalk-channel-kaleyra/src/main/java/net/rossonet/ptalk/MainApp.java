...
import net.rossonet.ptalk.channel.simulation.FakeCommunicationHandler;
...
public class MainApp {
	...
	public static void main(final String[] args) {
		try {
			...
			pTalkChannelRuntime = new PTalkChannelRuntime(configuration, new FakeCommunicationHandler());
