...
public class AiManagerFactFactory implements Closeable {

	private final Map<String, AiManagerFact> facts = new HashMap<>();
	private final PTalkEngineRuntime pTalkEngineRuntime;

	AiManagerFactFactory(PTalkEngineRuntime pTalkEngineRuntime) {
	...
	public AiManagerFact getOrCreate(Task rulesEngineTask) {
