...
public final class TunnelServiceV1Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.TunnelMessage,
      net.rossonet.ptalk.grpc.TunnelMessage> getOpenNetworkChannelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "openNetworkChannel",
      requestType = net.rossonet.ptalk.grpc.TunnelMessage.class,
      responseType = net.rossonet.ptalk.grpc.TunnelMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.TunnelMessage,
      net.rossonet.ptalk.grpc.TunnelMessage> getOpenNetworkChannelMethod() {
    io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.TunnelMessage, net.rossonet.ptalk.grpc.TunnelMessage> getOpenNetworkChannelMethod;
      ...
      synchronized (TunnelServiceV1Grpc.class) {
        if ((getOpenNetworkChannelMethod = TunnelServiceV1Grpc.getOpenNetworkChannelMethod) == null) {
          TunnelServiceV1Grpc.getOpenNetworkChannelMethod = getOpenNetworkChannelMethod =
              io.grpc.MethodDescriptor.<net.rossonet.ptalk.grpc.TunnelMessage, net.rossonet.ptalk.grpc.TunnelMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "openNetworkChannel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.rossonet.ptalk.grpc.TunnelMessage.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.RequestTunnelMessage,
      net.rossonet.ptalk.grpc.ResponseNetworkChannel> getRequestTunnelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RequestTunnel",
      requestType = net.rossonet.ptalk.grpc.RequestTunnelMessage.class,
      responseType = net.rossonet.ptalk.grpc.ResponseNetworkChannel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.RequestTunnelMessage,
      net.rossonet.ptalk.grpc.ResponseNetworkChannel> getRequestTunnelMethod() {
    io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.RequestTunnelMessage, net.rossonet.ptalk.grpc.ResponseNetworkChannel> getRequestTunnelMethod;
      ...
      synchronized (TunnelServiceV1Grpc.class) {
        if ((getRequestTunnelMethod = TunnelServiceV1Grpc.getRequestTunnelMethod) == null) {
          TunnelServiceV1Grpc.getRequestTunnelMethod = getRequestTunnelMethod =
              io.grpc.MethodDescriptor.<net.rossonet.ptalk.grpc.RequestTunnelMessage, net.rossonet.ptalk.grpc.ResponseNetworkChannel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RequestTunnel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.rossonet.ptalk.grpc.RequestTunnelMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.rossonet.ptalk.grpc.ResponseNetworkChannel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.AgentProxyRequest,
      net.rossonet.ptalk.grpc.AgentProxyReply> getProxyHttpRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ProxyHttpRequest",
      requestType = net.rossonet.ptalk.grpc.AgentProxyRequest.class,
      responseType = net.rossonet.ptalk.grpc.AgentProxyReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.AgentProxyRequest,
      net.rossonet.ptalk.grpc.AgentProxyReply> getProxyHttpRequestMethod() {
    io.grpc.MethodDescriptor<net.rossonet.ptalk.grpc.AgentProxyRequest, net.rossonet.ptalk.grpc.AgentProxyReply> getProxyHttpRequestMethod;
      ...
      synchronized (TunnelServiceV1Grpc.class) {
        if ((getProxyHttpRequestMethod = TunnelServiceV1Grpc.getProxyHttpRequestMethod) == null) {
          TunnelServiceV1Grpc.getProxyHttpRequestMethod = getProxyHttpRequestMethod =
              io.grpc.MethodDescriptor.<net.rossonet.ptalk.grpc.AgentProxyRequest, net.rossonet.ptalk.grpc.AgentProxyReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ProxyHttpRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.rossonet.ptalk.grpc.AgentProxyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.rossonet.ptalk.grpc.AgentProxyReply.getDefaultInstance()))
  ...
  public static abstract class TunnelServiceV1ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.TunnelMessage> openNetworkChannel(
        io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.TunnelMessage> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getOpenNetworkChannelMethod(), responseObserver);
    }

    /**
     */
    public void requestTunnel(net.rossonet.ptalk.grpc.RequestTunnelMessage request,
        io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.ResponseNetworkChannel> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRequestTunnelMethod(), responseObserver);
    }

    /**
     */
    public void proxyHttpRequest(net.rossonet.ptalk.grpc.AgentProxyRequest request,
        io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.AgentProxyReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                net.rossonet.ptalk.grpc.TunnelMessage,
                net.rossonet.ptalk.grpc.TunnelMessage>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                net.rossonet.ptalk.grpc.RequestTunnelMessage,
                net.rossonet.ptalk.grpc.ResponseNetworkChannel>(
                  this, METHODID_REQUEST_TUNNEL)))
          .addMethod(
            getProxyHttpRequestMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                net.rossonet.ptalk.grpc.AgentProxyRequest,
                net.rossonet.ptalk.grpc.AgentProxyReply>(
  ...
  public static final class TunnelServiceV1BlockingStub extends io.grpc.stub.AbstractBlockingStub<TunnelServiceV1BlockingStub> {
    ...
    /**
     */
    public net.rossonet.ptalk.grpc.ResponseNetworkChannel requestTunnel(net.rossonet.ptalk.grpc.RequestTunnelMessage request) {
    ...
    /**
     */
    public net.rossonet.ptalk.grpc.AgentProxyReply proxyHttpRequest(net.rossonet.ptalk.grpc.AgentProxyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TunnelServiceV1FutureStub extends io.grpc.stub.AbstractFutureStub<TunnelServiceV1FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.rossonet.ptalk.grpc.ResponseNetworkChannel> requestTunnel(
        net.rossonet.ptalk.grpc.RequestTunnelMessage request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.rossonet.ptalk.grpc.AgentProxyReply> proxyHttpRequest(
        net.rossonet.ptalk.grpc.AgentProxyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST_TUNNEL:
          serviceImpl.requestTunnel((net.rossonet.ptalk.grpc.RequestTunnelMessage) request,
              (io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.ResponseNetworkChannel>) responseObserver);
          break;
        case METHODID_PROXY_HTTP_REQUEST:
          serviceImpl.proxyHttpRequest((net.rossonet.ptalk.grpc.AgentProxyRequest) request,
              (io.grpc.stub.StreamObserver<net.rossonet.ptalk.grpc.AgentProxyReply>) responseObserver);
          break;
        default:
